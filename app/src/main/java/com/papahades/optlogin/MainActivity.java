package com.papahades.optlogin;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnGenerateOTP=findViewById(R.id.button);
        btnSignIn=findViewById(R.id.button2);
        etPhoneNumber=findViewById(R.id.editTextPhone);
        etOTP=findViewById(R.id.otpTextView);
        ...
        btnSignIn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               if(otp.length()==0){
                   Toast.makeText(getApplicationContext(),"enter Opt",Toast.LENGTH_LONG).show();
               }
               else {
